        ...
        <div className="navbar--container">
            ...
            <ul className="navList">
                <li className="list item--1">
                    ...
                    <Link className="nav-link heading kill-link-style" to={"/"}>My Collections</Link>
                </li>
                <li className="list item--2">
                    <Image className="nav-icon icon-2" 
                        cloudName="photojam-nss" 
                        publicId= "nativeSite/image_add_icon_hcrhgh"/>
                    <Link className="nav-link heading kill-link-style" to={"/new-collection"}>New Collection</Link>
                </li>
                <li className="list item--3">
                    <Image className="nav-icon icon-3" 
                        cloudName="photojam-nss" 
                        publicId= "nativeSite/profile_edit_user_icon_itngou"/>
                    <Link className="nav-link heading kill-link-style" to={"/edit-profile"}>Edit Profile</Link>
                </li>
            </ul>
            <ul className="navList">
                <li className="list item--4">
                    ...
                    <Link to=""
                        className="nav-link heading kill-link-style" 
                        onClick={() => {
